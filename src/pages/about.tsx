...
const About = () => {
  const values = {
    ...
    p2: "Ever since I was young, I've had a sweet tooth. Nowadays, in my spare time, I love to bake cookies and other types of sweets for my friends and family. Recently, I started my sourdough joruney with my starter named ",

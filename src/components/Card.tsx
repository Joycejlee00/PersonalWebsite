            ...
            <div className='card lg:card-side'>
              <div className='body'>
                <div className='text'>
                  ...
                  <p className={`text-[0.7rem] ${workSans.className}`}>{props.p1} <br/> <br/> {props.p2} <b><i>Job 🍞</i></b> <br/> <br/> {props.p3} <br/> <br/> {props.p8} <br/> <br/> {props.p4} <br/> <br/> {props.p5} {props.p6} <br/> <br/> {props.p7} </p>
                </div>
              </div>
            </div>
          )
